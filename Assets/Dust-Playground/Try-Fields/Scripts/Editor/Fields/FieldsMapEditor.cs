    ...
    public class FieldsMapEditor
    {
        ...
        private bool DrawFieldItem(SerializedProperty item, int itemIndex, int itemsCount)
        {
            ...
            DustGUI.BeginHorizontal();
            {
                ...
                var fieldIcon = Playground.UI.Icons.GetTextureByComponent(newRecord.field, !fieldEnabledInScene ? "Disabled" : "");
        ...
        private void DrawAddFieldButton()
        {
            DustGUI.BeginHorizontal();
            {
                if (DustGUI.IconButton(Playground.UI.Icons.ACTION_ADD_FIELD, CELL_WIDTH_ICON, CELL_WIDTH_ICON, UI.ExtraList.styleMiniButton))
